...
REG_ADDR(__tx_fctrl_id, 0x24, 0x20);
REG_ADDR(__tx_fctrl_hi_id, 0x28, 0x24);
REG_ADDR(__dx_time_id, 0x2c, 0x28);
REG_ADDR(__rx_ttcko_lo_id, 0x5c, 0x58);
REG_ADDR(__rx_ttcko_hi_id, 0x60, 0x5c);
REG_ADDR(__rx_time_0_id, 0x64, 0x60);
REG_ADDR(__rx_time_1_id, 0x68, 0x64);
REG_ADDR(__rx_time_2_id, 0x6c, 0x68);
REG_ADDR(__rx_time_3_id, 0x70, 0x6c);
REG_ADDR(__tx_time_lo_id, 0x74, 0x70);
REG_ADDR(__tx_time_hi_id, 0x78, 0x74);
REG_ADDR(__tx_time_2_id, 0x10000, 0x78);
REG_ADDR(__tx_antd_id, 0x10004, 0x7c);
REG_ADDR(__ack_resp_id, 0x10008, 0x10000);
REG_ADDR(__tx_power_id, 0x1000c, 0x10004);
REG_ADDR(__chan_ctrl_id, 0x10014, 0x10008);
REG_ADDR(__le_pend_01_id, 0x10018, 0x1000C);
REG_ADDR(__le_pend_23_id, 0x1001c, 0x10010);
REG_ADDR(__spi_collision_status_id, 0x10020, 0x10014);
REG_ADDR(__rdb_status_id, 0x10024, 0x10018);
REG_ADDR(__rdb_diag_mode_id, 0x10028, 0x10020);
REG_ADDR(__regmap_ver_id, 0x1002c, 0x10024);
REG_ADDR(__sar_ctrl_sar_force_sel_bit_len, 3U, 4U);
REG_ADDR(__sar_ctrl_sar_force_sel_bit_mask, 0x7000U, 0xf000U);
REG_ADDR(__nvm_cfg_gear_id_bit_offset, 11U, 12U);
REG_ADDR(__nvm_cfg_gear_id_bit_mask, 0x1800U, 0x3000U);
REG_ADDR(__nvm_cfg_gear_kick_bit_offset, 10U, 0x11U);
REG_ADDR(__nvm_cfg_gear_kick_bit_mask, 0x400U, 0x800U);
REG_ADDR(__nvm_cfg_bias_kick_bit_offset, 8U, 10U);
REG_ADDR(__nvm_cfg_bias_kick_bit_mask, 0x100U, 0x400U);
REG_ADDR(__nvm_cfg_ldo_kick_bit_offset, 7U, 9U);
REG_ADDR(__nvm_cfg_ldo_kick_bit_mask, 0x80U, 0x200U);
REG_ADDR(__nvm_cfg_dgc_kick_bit_offset, 6U, 8U);
REG_ADDR(__nvm_cfg_dgc_kick_bit_mask, 0x40U, 0x100U);
REG_ADDR(__nvm_cfg_dgc_sel_bit_offset, 13U, 7U);
REG_ADDR(__nvm_cfg_dgc_sel_bit_mask, 0x2000U, 0x80U);
REG_ADDR(__nvm_cfg_nvm_pd_bit_offset, 9U, 6U);
REG_ADDR(__nvm_cfg_nvm_pd_bit_mask, 0x200U, 0x40U);
REG_ADDR(__ip_diag_1_ipchannelarea_bit_len, 17U, 19U);
REG_ADDR(__ip_diag_1_ipchannelarea_bit_mask, 0x1ffffUL, 0x7ffffUL);
REG_ADDR(__cy0_diag_1_cy0channelarea_bit_len, 16U, 19U);
REG_ADDR(__cy0_diag_1_cy0channelarea_bit_mask, 0xffffU, 0x7ffffU);
REG_ADDR(__cy1_diag_1_cy1channelarea_bit_len, 16U, 19U);
REG_ADDR(__cy1_diag_1_cy1channelarea_bit_mask, 0xffffU, 0x7ffffU);
REG_ADDR(__ip_config_hi_id, 0xe000e, 0xe0010);
REG_ADDR(__cy_config_lo_id, 0xe0012, 0xe0014);
REG_ADDR(__cy_config_hi_id, 0xe0016, 0xe0018);
REG_ADDR(__cia_coefficient_adjust_id, 0xe001a, 0xe001c);
REG_ADDR(__pgf_delay_comp_lo_id, 0xe001e, 0xe0020);
REG_ADDR(__pgf_delay_comp_hi_id, 0xe0022, 0xe0024);
REG_ADDR(__adc_mem_ptr_id, 0xf0020, 0xf0024);
REG_ADDR(__test_ctrl0_id, 0xf0024, 0xf0028);
REG_ADDR(__fcmd_status_id, 0xf003c, 0xf0040);
REG_ADDR(__test_logging_id, 0xf0040, 0xf0044);
REG_ADDR(__status_logging_id, 0xf0044, 0xf0048);
REG_ADDR(__ctr_dbg_id, 0xf0048, 0xf004C);
REG_ADDR(__led_ctrl_id, 0x110016, 0x110018);
REG_ADDR(__rx_ppm_id, 0x11001a, 0x11001c);
REG_ADDR(__fosc_ctrl_id, 0x11001e, 0x110020);
REG_ADDR(__bias_ctrl_id, 0x11001f, 0x110030);
REG_ADDR(__bias_ctrl_dig_bias_ctrl_tc_r3_ulv_bit_offset, 12U, 9U);
REG_ADDR(__bias_ctrl_dig_bias_ctrl_tc_r3_ulv_bit_mask, 0x3000U, 0x600U);
/* LDO and BIAS tune kick */
/* C0 : Writing to bit 7 and 8 */
/* D0 NOTE: only kick LDO bit 9 (Writing to bit 10 for BIAS and 9 for LDO) */
REG_ADDR(__ldo_bias_kick, 0x180, 0x200);
